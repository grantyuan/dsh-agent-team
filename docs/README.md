...
| [`team-collaboration.md`](team-collaboration.md) | The implemented ten-tool, Thread Attention, Inbox, reading, mention, and mutation-fence contract | Changing collaboration semantics, model-facing tools, or Agent notifications |
