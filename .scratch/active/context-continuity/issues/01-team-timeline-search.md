...
**Status:** in-progress — split delivery: commit A lands ①②④ (ledger-derived Session lineage, the `dsh-session-query` peer, the engine's search/read factory mounted with Team's scope); commit B lands ③⑤ and re-verifies ⑥.
