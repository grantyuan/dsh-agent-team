export const zh = {
  ...
  resumeAgent: '恢复',
  analyzeAgent: '分析错误',
  analyzeAgentDispatched: '已派发 doctor 分析 {name} 的错误上下文。',
  analyzeAgentFailed: '分析派发失败：{message}',
  restartAgent: '重启',
  ...
  resetAgent: '重置',
  resetAgentTitle: '重置 Agent：{name}',
  resetAgentNotice: '将结束 {name} 的当前会话并开启新会话：新会话从空上下文开始，旧会话日志归档保留，私有记忆不受影响。',
  resetAgentConfirm: '重置',
  resetAgentFailed: '重置失败：{message}',
  compactAgent: '压缩',
  compactAgentTitle: '压缩 Agent：{name}',
  compactAgentNotice: '选择用于生成摘要的 LLM。压缩会插在 {name} 当前动作之后执行，不阻塞之后的会话。',
  compactAgentRun: '开始压缩',
  compactAgentRunning: '正在提交…',
  compactAgentScheduled: '已提交压缩，将在当前动作结束后执行。',
  compactAgentFailed: '压缩失败：{message}',
  compactModelFollowSession: '跟随会话当前模型',
  archiveAgent: '归档',
...
export const en = {
  ...
  resumeAgent: 'Resume',
  analyzeAgent: 'Analyze error',
  analyzeAgentDispatched: "Dispatched doctor to analyze {name}'s failed context.",
  analyzeAgentFailed: 'Failed to dispatch analysis: {message}',
  ...
  resetAgent: 'Reset',
  resetAgentTitle: 'Reset Agent: {name}',
  resetAgentNotice: "Ends {name}'s current session and opens a new one: the new session starts with empty context, the old log stays archived on disk, and private memory is untouched.",
  resetAgentConfirm: 'Reset',
  resetAgentFailed: 'Reset failed: {message}',
  compactAgent: 'Compact',
  compactAgentTitle: 'Compact Agent: {name}',
  compactAgentNotice: "Pick the LLM that writes the summary. The compaction runs after {name}'s current activity finishes and does not block later work.",
  compactAgentRun: 'Compact',
  compactAgentRunning: 'Submitting…',
  compactAgentScheduled: 'Compaction scheduled; it will run once the current activity finishes.',
  compactAgentFailed: 'Compaction failed: {message}',
  compactModelFollowSession: "Follow the session's current model",
