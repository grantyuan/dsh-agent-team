export const zh = {
  ...
  humanSettingsAvatarHint: '只收图片，最大 10MB；删除或损坏时回退为默认头像。',
...
export const en = {
  ...
  humanSettingsAvatarHint: 'Images only, up to 10MB; falls back to the default avatar when removed or unreadable.',
